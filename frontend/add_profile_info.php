...
$sql="INSERT INTO chitietnguoidung (id,hoten,diachi,sodienthoai) VALUE ($id,'$hoten','$diachi','$sodienthoai')";
...
<header class="header fixed">
    ...
    <form action="#" method="POST"  class="info">
        <div class="content"><p class="demuc"><span class="aa">First and last name:</span> <input type="text" name="hoten" class="data"></div>
        <div class="content">
          <p class="demuc"><span class="aa">Address:</span> <input type="text" name="diachi" class="data"></p>
        </div>
        <div class="content">
          <p class="demuc"><span class="aa">Phone number:</span> <input type="text" name="sodienthoai" class="data"></p>
        </div>
        <a href=""><button type="submid" name="btn" class="btn ">ADD PROFILE</button></a>
      </form>
    </main>
    <footer class="footer">
      <div class="main-content">
