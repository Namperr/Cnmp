...
<head>
    ...
    <title>FROFILE INFOMATION</title>
  </head>
...
<header class="header fixed">
    ...
    <div class="info">
      <div class="content"><p class="demuc"><span class="aa">First and last name:</span> <?php echo $ten;?></div>
      <div class="content">
        <p class="demuc"><span class="aa">Address:</span> <?php echo $diachi;?></p>
      </div>
      <div class="content">
        <p class="demuc"><span class="aa">Phone number:</span> <?php echo $dienthoai;?></p>
      </div>
      <div class="content">
        <p class="demuc"><span class="aa">Gmail:</span> <?php echo $gmail;?></p>
      </div>
      <a href="update_profile_info.php"><button type="submid" name="btn" class="btn ">UPDATE PROFILE</button></a>
      <a href="add_profile_info.php"><button type="submid" class="btn">ADD PROFILE</button></a>
    </div>
    </main>
    <footer class="footer">
      <div class="main-content">
